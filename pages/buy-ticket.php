...
if (isset($_POST['buy'])) {
    ...
    // Check if it is numeric AND exactly 8 digits
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; transition: all 0.3s ease; }
        ...
        .summary-title { font-size: 0.75rem; font-weight: 800; color: var(--accent-primary); text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px; }
        ...
        .purchase-btn {
            ...
            border-radius: 12px; color: white; font-weight: 800; font-size: 1rem;
            cursor: pointer; margin-top: 10px; display: flex; justify-content: center;
            align-items: center; gap: 10px;
        }

        .purchase-btn:hover { transform: translateY(-2px); filter: brightness(1.1); }
...
<script>
    // Additional JavaScript to block non-numeric keys
